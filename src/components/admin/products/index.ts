...
router.put('/update', checkSchema(UPDATE_PRODUCT_SCHEMA), checkValidation, controller.updatesProduct);
router.get('/get', checkSchema(PRODUCT_ID_SCHEMA), checkValidation, controller.getProductByID);
